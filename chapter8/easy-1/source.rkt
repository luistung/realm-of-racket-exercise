...
(define HEALING 8)
(define AGILITY-REGAIN 8)
(define STRENGTH-REGAIN 8)
...
(define INSTRUCTIONS-1
  "Press S to stab a monster | Press F to Flail wildly | Press H to Heal | Press R to regain strength and agility")
...
(define (regain w)
  (decrease-attack# w)
  (player-agility+ (orc-world-player w) AGILITY-REGAIN)
  (player-strength+ (orc-world-player w) STRENGTH-REGAIN))
